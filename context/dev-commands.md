---
title: ThermalAI — Dev Commands
description: First-time setup, service start order, test commands, MongoDB queries, ML retraining workflow, and production build
modules:
